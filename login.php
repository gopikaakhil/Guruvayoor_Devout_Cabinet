	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="../../company/show.php" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="email" name="u_id">
				...
				<div class="login100-more" style="background-image: url('images/thulasi.jpg');">
				</div>
			</div>
		</div>
	</div>
