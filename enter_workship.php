...
$sql="insert into daily_workship (work_name,work_price,work_type) values('$work_name','$work_price','$work_type')";
$result=mysql_query($sql,$con);
}
	?>
</head>
...
<header>		
					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="enter_workship.php" class="active">Workship</a></li>								
	...
	<div class="sub-main-w3">
		...
		<div class="form-group">
				...
				<option value="presadham">Presadham</option>
